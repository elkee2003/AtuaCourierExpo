 ...
 *
 * AUTOMATIC REASSIGNMENT TEMPORARILY DISABLED.
 *
 * Manual courier order listing and acceptance will be used instead.
 *
 * IMPORTANT:
 * The original reassignOrder code should remain below,
 * commented out, so it can be restored later.
 */
...
exports.handler = async (event, context) => {
  ...
  console.log("==================================================");
  console.log("AUTOMATIC REASSIGNMENT DISABLED");
  console.log("==================================================");

  console.log("REASSIGNMENT DISABLED INVOCATION:", {
    invocationId,
  ...
  /**
   * Returning success tells Lambda/SQS that the message
   * was handled successfully.
   *
   * This prevents the same SQS message from being retried
   * repeatedly while automatic reassignment is disabled.
   */
  return {
    ok: true,
    disabled: true,
    processed: records.length,
    message: "Automatic courier reassignment is temporarily disabled.",
    invocationId,
  };
};
...
/*
|--------------------------------------------------------------------------
| ORIGINAL REASSIGNORDER CODE
|--------------------------------------------------------------------------
|
| Keep the complete original reassignOrder code below.
|
| Do not delete it.
|
| Do not leave another active exports.handler below.
|
| The original code should remain commented out.
|
|--------------------------------------------------------------------------
*/

/*
  Your original reassignOrder code continues below.
*/
