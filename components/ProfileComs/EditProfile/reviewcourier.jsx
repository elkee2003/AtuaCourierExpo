...
const ReviewCourierCom = () => {
    const {
        firstName, lastName, profilePic, transportationType, vehicleClass, model, plateNumber, maxiImages, address, phoneNumber, landMark, courierNIN, courierNINImage, bankName, accountName, accountNumber, maxiDescription, 
    } = useProfileContext()
  ...
  return (
    <View style={styles.reviewContainer}>
        ...
        >
                ...
                {maxiDescription && renderField("Maxi Description", maxiDescription)}
